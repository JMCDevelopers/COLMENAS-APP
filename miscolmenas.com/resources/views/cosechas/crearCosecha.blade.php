          ...
          <div class="box-body">
            <form class="" action="{{route('guardar_cosecha')}}" method="post" id="frm_cosecha" enctype="multipart/form-data">
              ...
              <div class="form-group" id="apiario2">
                ...
                <input type="date" name="fecha_cosecha" id="fecha_cosecha" value="">
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  ...
                  <button type="button" class="btn btn-success btn-xs" name="button" onclick="ObtenerColmenasApiario();" >Consultar Colmenas</button>
                </div>
                </form>
                <div class="panel-body" id="contenedor_colmenas">
