...
<html lang="en">
  ...
  <body>
    <header class="clearfix">
      ...
      <h1>Mis Colmenas - Reporte Reinas</h1>
    ...
    <div  style="padding-right: 30px;">
      <table>
        <thead>
          <tr>
            <th class="service">#</th>
            <th class="desc">IDENTIFICADOR</th>
            <th>ORIGEN</th>
            <th>RAZA</th>
            <th>ESTADO</th>
            <th>INSTALADO</th>
        ...
        <tbody>
          @foreach ($reinas as $key => $value)
            ...
            <tr>
              ...
              <td class="desc">{{$value->identificador_reina}}</td>
              <td class="total">{{$value->procedencia}}</td>
              <td class="qty">{{$value->nombre}}</td>
              <td class="qty">{{$value->tipo}}</td>
              <td class="qty">{{$value->instalado}}</td>
              <td class="qty">{{$date1." meses"}}</td>
