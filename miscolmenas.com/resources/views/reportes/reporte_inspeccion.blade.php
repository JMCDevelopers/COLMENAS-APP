...
<html lang="en">
  ...
  <body>
    <header class="clearfix">
      ...
      <h1>Mis Colmenas - Reporte Inspecciones</h1>
        ...
        <tbody>
          @foreach ($inspecciones as $key => $value)
            ...
            <tr>
              ...
              <td class="desc">{{$value->fecha_inspeccion}}</td>
              <td class="total">{{$value->postura}}</td>
              <td class="qty">{{$value->fuerza_poblacion}}</td>
              <td class="qty">{{$value->temperamento_colmena}}</td>
              <td class="qty">{{$value->identificador_colmena}}</td>
